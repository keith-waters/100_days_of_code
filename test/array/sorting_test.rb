...
class TestSorting < Minitest::Test
  ...
  def test_kth_smallest_quick_sort
    assert_equal @sorting.kth_smallest_quick_sort([4,3,20,7,10,15], 3), 7
    assert_equal @sorting.kth_smallest_quick_sort([7,10,4,3,20,15], 4), 10
    assert_equal @sorting.kth_smallest_quick_sort([7,10,4,3,20,15], 6), 20 
  end
end